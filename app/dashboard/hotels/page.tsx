          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <Card hover={false}>
              ...
              <CardContent>
                ...
                {/* Suppliers List - Simple Scrollable Container */}
                <div className="relative">
                  <div
                    className="h-96 overflow-y-scroll border-2 border-gray-300 rounded-lg bg-white p-3"
                    style={{
                      scrollbarWidth: "thin",
                    ...
                    {hotelInfo.topSuppliers
                      ...
                      .map((supplier, filteredIndex) => {
                        ...
                        return (
                          <div
                            key={supplier.name}
                            className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200 mb-3 last:mb-0"
                          >
                            <div className="flex items-center space-x-3">
